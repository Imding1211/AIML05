...
#====================================================================================================================#
    ...
    def search(self, filter_params=None, sort_params=None):
        ...
        # 取得物件總數
        r = s.get(url, params=params + f'&firstRow={page*30}', headers=headers)
        data = r.json()
        total_count = data['records']

        # 計算總頁數
        total_count_int = int(''.join(re.findall(r'\b\d+\b', total_count)))
        want_page = int(total_count_int/30)+1
...
def add_url(data):
    ...
    :param data: 物件的list
    :return data: 加入url物件的list
    """

    for info in data:
        info['url'] = f'https://rent.591.com.tw/home/{info["post_id"]}'
...
if __name__ == "__main__":
    ...
    with open('house_detail.json', 'w', encoding='utf8') as f:
        f.write(json.dumps(house_detail, indent=4, ensure_ascii=False))
    '''